...
def extractFeat(url):
    ...
    print(protocol,path,domain,having_ip,len_url,having_at_symbol,redirection_symbol,prefix_suffix_separation,sub_domains,tiny_url,
    web_traffic,domain_registration_length,dns_record,statistical_report,age_domain,http_tokens)

    return[domain,having_at_symbol,having_ip,path,prefix_suffix_separation,protocol,redirection_symbol,sub_domains,len_url,age_domain,dns_record,domain_registration_length,http_tokens,statistical_report,tiny_url,web_traffic]
